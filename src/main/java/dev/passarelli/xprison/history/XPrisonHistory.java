package dev.passarelli.xprison.history;

import dev.passarelli.xprison.XPrison;
import dev.passarelli.xprison.XPrisonModule;
import dev.passarelli.xprison.autominer.api.events.PlayerAutoMinerTimeModifyEvent;
import dev.passarelli.xprison.autominer.api.events.PlayerAutomineEvent;
import dev.passarelli.xprison.gangs.api.events.GangCreateEvent;
import dev.passarelli.xprison.gangs.api.events.GangDisbandEvent;
import dev.passarelli.xprison.gangs.api.events.GangJoinEvent;
import dev.passarelli.xprison.gangs.api.events.GangLeaveEvent;
import dev.passarelli.xprison.gems.api.events.PlayerGemsLostEvent;
import dev.passarelli.xprison.gems.api.events.PlayerGemsReceiveEvent;
import dev.passarelli.xprison.history.api.XPrisonHistoryAPI;
import dev.passarelli.xprison.history.api.XPrisonHistoryAPIImpl;
import dev.passarelli.xprison.history.gui.PlayerHistoryGUI;
import dev.passarelli.xprison.history.manager.HistoryManager;
import dev.passarelli.xprison.history.repo.HistoryRepository;
import dev.passarelli.xprison.history.repo.impl.HistoryRepositoryImpl;
import dev.passarelli.xprison.history.service.HistoryService;
import dev.passarelli.xprison.history.service.impl.HistoryServiceImpl;
import dev.passarelli.xprison.multipliers.api.events.PlayerMultiplierReceiveEvent;
import dev.passarelli.xprison.prestiges.api.events.PlayerPrestigeEvent;
import dev.passarelli.xprison.ranks.api.events.PlayerRankUpEvent;
import dev.passarelli.xprison.tokens.api.events.PlayerTokensLostEvent;
import dev.passarelli.xprison.tokens.api.events.PlayerTokensReceiveEvent;
import dev.passarelli.xprison.utils.misc.TimeUtil;
