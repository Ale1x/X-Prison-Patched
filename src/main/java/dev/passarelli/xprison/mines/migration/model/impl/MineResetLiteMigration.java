package dev.passarelli.xprison.mines.migration.model.impl;
...
import dev.passarelli.xprison.mines.model.mine.BlockPalette;
...
public final class MineResetLiteMigration extends MinesMigration<Mine> {
	...
	@Override
	protected dev.passarelli.xprison.mines.model.mine.Mine migrate(Mine mine) {
		dev.passarelli.xprison.mines.model.mine.Mine.Builder builder = new dev.passarelli.xprison.mines.model.mine.Mine.Builder();
