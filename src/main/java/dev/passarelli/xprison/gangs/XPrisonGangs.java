package dev.passarelli.xprison.gangs;

import dev.passarelli.xprison.XPrison;
import dev.passarelli.xprison.XPrisonModule;
import dev.passarelli.xprison.gangs.api.XPrisonGangsAPI;
import dev.passarelli.xprison.gangs.api.XPrisonGangsAPIImpl;
import dev.passarelli.xprison.gangs.commands.GangCommand;
import dev.passarelli.xprison.gangs.config.GangsConfig;
import dev.passarelli.xprison.gangs.listener.GangsListener;
import dev.passarelli.xprison.gangs.managers.GangsManager;
import dev.passarelli.xprison.gangs.model.GangTopByValueProvider;
import dev.passarelli.xprison.gangs.model.GangTopProvider;
import dev.passarelli.xprison.gangs.model.GangUpdateTopTask;
import dev.passarelli.xprison.gangs.repo.GangsRepository;
import dev.passarelli.xprison.gangs.repo.impl.GangsRepositoryImpl;
import dev.passarelli.xprison.gangs.service.GangsService;
import dev.passarelli.xprison.gangs.service.impl.GangsServiceImpl;
